...
Student::Student(string id, string first, string last, string email, int age, int days[], DegreeProgram degreeName) /*Full Constructor*/
{
	this->id = id;
	this->first = first;
	this->last = last;
...
{
	cout << "Format: Student ID|First Name|Last Name|Email|Age|Average Days\n";
}
